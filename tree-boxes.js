...
function treeBoxes(urlService, jsonData) {
  ...
  var translation, translationLinkAdd, scale;
  ...
  function update(source) {
    ...
    // function getCenter() {
    //   var bbox = d3.select(".tooltip-link-add").node().getBBox();
  ...
  function zoomAndDrag() {
    ...
    scale = 1;
    var tbound = -height,
      bbound = 1.8 * (height * scale),
      lbound = 0,
      rbound = 1.8 * width * scale;
